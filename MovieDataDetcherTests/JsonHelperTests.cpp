...
TEST(JsonTests, GetMatchingTitleIdFromMovieList_PassOnlyOneMovieWithRightName_ReturnThatMovieId)
{
...
TEST(JsonTests, GetMatchingTitleIdFromMovieList_PassOnlyOneMovieWithWrongName_ReturnThatMovieId)
{
...
TEST(JsonTests, GetMatchingTitleIdFromMovieList_PassMovieList_ReturnBestMatchingTitleId)
{
...
TEST(JsonTests, GetMatchingTitleIdFromMovieList_PassMovieListSimilarNameNotFirst_ReturnBestMatchingTitleId)
{
...
TEST(JsonTests, GetMatchingTitleIdFromMovieList_PassEmptyJsonString_ThrowInvalidInputException)
{
	std::string input = "";
